...
if(e instanceof Array)for(var a=0;a<e.length;a++)t(e[a]);else "object"==typeof e&&t(e)}),(r.prototype.removeCalendarEvent=function(e){var n=this;function t(e){var t,a=n.options.calendarEvents.map(function(e){return e.id}).indexOf(e);0<=a?((t=n.options.calendarEvents[a]),n.options.calendarEvents.splice(a,1),n.removeEventList(e),n.removeEventIndicator(t)):console.log("%c "+e+": ID not found ","color:white;font-weight:bold;background-color:#e21d1d;")}
if(e instanceof Array)for(var a=0;a<e.length;a++)t(e[a]);else t(e)}),(r.prototype.isValidDate=function(e){return new Date(e)&&!isNaN(new Date(e).getTime())}),(d.fn.evoCalendar=function(){for(var e,t=this,a=arguments[0],n=Array.prototype.slice.call(arguments,1),i=t.length,o=0;o<i;o++)
